...
@section('content')
    <div class="container mt-5 mb-5">
        <h3>Startup CMC Holdings successfully raised capital of 1.5 million USD</h3>

        <p>
            <i>After a one-hour call, a startup establishing the digital economy successfully secured $1.5 million in a Co-founder round to develop the digital economy ecosystem.</i>
        </p>

        <p>With a roadmap of 7 investment rounds: co-founder, angel, Series A, B, C, PE, and IB, the company declared that it has met the IPO target of $300 billion USD by 2027.</p>
        ...
        <p>From the beginning, CMC Holdings has focused on solving social problems and sustainable development. </p>
        <p>It attaches great importance to social values and focuses on the vital core areas of this world.</p>
        <p>Divega is the SIB (Social Impact Business) model. The project not only gives a place to trade genuine and limited goods at "unbelievable" prices under the lowest auction but the profits will be used for society's charity.</p>
        <p>Co-founders who are also business owners and individual investors successfully raised the first round of investment. </p>
        <p>Most investors' selections are based on a thorough grasp of the digital economy's value to the market, as well as extensive proof of successful enterprises over time. </p>
